...
abstract class AbstractMainDashboardPage extends StatelessWidget {
  const AbstractMainDashboardPage({super.key, required this.title});

  final String title;

  Widget buildWidgetWithSliverAppBar(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Icon(Icons.fiber_new_rounded, color: theme.primaryColor),
                  SizedBox(width: 8),
                  Text(
                    title,
