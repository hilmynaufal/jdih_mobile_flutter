...
class HukumPopulerWidget extends StatelessWidget {
  HukumPopulerWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (controller.hukumPopuler.isEmpty) {
      controller.getHukumPopuler();
    }

    return Obx(() {
      final isLoading = controller.hukumPopuler.isEmpty;
            ...
            children: [
              ...
              Padding(
                ...
                child: IntrinsicHeight(
                  child: Row(
                    ...
                    children: [
                      Container(color: Colors.purple, width: 4),
                      SizedBox(width: 4),
                      Text(
                        'Hukum Populer',
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: isLoading ? 2 : controller.hukumPopuler.length,
                  itemBuilder: (context, index) {
                    final dokumen =
                        isLoading ? null : controller.hukumPopuler[index];
                    ...
                    return InkWell(
                      onTap: isLoading
                          ...
                          : () async {
                              ...
                              final detailDokumen =
                                  await controller.getDetailDokumen(dokumen!.id!);
