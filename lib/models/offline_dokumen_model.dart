...
part 'offline_dokumen_model.g.dart';

@HiveType(typeId: 2)
class OfflineDokumenModel extends HiveObject {
  @HiveField(0)
  String? id;
  @HiveField(1)
  String? idJenis;
  ...
  String? judul;
  @HiveField(40)
  String? localFilePath; // Path file di local storage
  @HiveField(41)
  DateTime tanggalDisimpan;
  @HiveField(42)
  int? fileSize; // Ukuran file dalam bytes
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'tanggalDisimpan': tanggalDisimpan.toIso8601String(),
      'fileSize': fileSize,
    };
  }

  factory OfflineDokumenModel.fromJson(Map<String, dynamic> json) {
    return OfflineDokumenModel(
      id: json['id'],
      ...
      tanggalDisimpan: DateTime.parse(json['tanggalDisimpan']),
      fileSize: json['fileSize'],
    );
  }

  factory OfflineDokumenModel.fromDetail({
    required DetailDokumenModel detail,
    required DateTime tanggalDisimpan,
