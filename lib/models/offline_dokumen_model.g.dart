...
part of 'offline_dokumen_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class OfflineDokumenModelAdapter extends TypeAdapter<OfflineDokumenModel> {
  @override
  final int typeId = 2;

  @override
  OfflineDokumenModel read(BinaryReader reader) {
    ...
    return OfflineDokumenModel(
      ...
      localFilePath: fields[40] as String?,
      tanggalDisimpan: fields[41] as DateTime,
      fileSize: fields[42] as int?,
    );
  }

  @override
  void write(BinaryWriter writer, OfflineDokumenModel obj) {
    writer
      ..writeByte(43)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is OfflineDokumenModelAdapter &&
