...
class RiwayatPage extends StatelessWidget {
  ...
  void _onRiwayatTap(RiwayatDokumenModel riwayat) {
    ...
    final detailDokumen = DetailDokumenModel(
      id: riwayat.id,
      idJenis: riwayat.idJenis,
      idStatus: riwayat.idStatus,
      nama: riwayat.nama,
      namaInggris: riwayat.namaInggris,
      no: riwayat.no,
      tahun: riwayat.tahun,
      tanggalDitetapkan: riwayat.tanggalDitetapkan,
      tanggalDiundangkan: riwayat.tanggalDiundangkan,
      katalog: riwayat.katalog,
      abstrak: riwayat.abstrak,
      penganti: riwayat.penganti,
      jumlahUnduh: riwayat.jumlahUnduh,
      dibaca: riwayat.dibaca,
      didownload: riwayat.didownload,
      visible: riwayat.visible,
      sumber: riwayat.sumber,
      subjek: riwayat.subjek,
      statusPeraturan: riwayat.statusPeraturan,
      bahasa: riwayat.bahasa,
      lokasi: riwayat.lokasi,
      bidangHukum: riwayat.bidangHukum,
      kodeLampiran: riwayat.kodeLampiran,
      tempatPenetapan: riwayat.tempatPenetapan,
      tentang: riwayat.tentang,
      jenisDokumen: riwayat.jenisDokumen,
      createdAt: riwayat.createdAt,
      createdBy: riwayat.createdBy,
      updatedAt: riwayat.updatedAt,
      updatedBy: riwayat.updatedBy,
      statusNama: riwayat.statusNama,
      jenisId: riwayat.jenisId,
      jenisNama: riwayat.jenisNama,
      jenisKeterangan: riwayat.jenisKeterangan,
      pathFileAbstrak: riwayat.pathFileAbstrak,
      pathFileInggris: riwayat.pathFileInggris,
      pathPeraturan: riwayat.pathPeraturan,
      dokumenId: riwayat.dokumenId,
