      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              Text(
                'Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan mengungkapkan informasi Anda. Silakan baca dengan seksama.',
              ...
              Column(
                children: [
                  SizedBox(height: 20),
                  CheckboxListTile(
                    title: Text('Saya setuju dengan Kebijakan Privasi ini'),
                    value: _isAgreed,
                  ...
                  ElevatedButton(
                    onPressed:
                        _isAgreed
                            ? () {
                              widget.controller.setPrivacyAgreed(true);
                              Get.offNamed("/");
                            }
                            : null,
                    child: Text('Lanjut'),
